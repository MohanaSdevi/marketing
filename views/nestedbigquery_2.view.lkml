# The name of this view in Looker is "Nestedbigquery 2"
view: nestedbigquery_2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `marketing_analytics.nestedbigquery_2` ;;
...
# The name of this view in Looker is "Nestedbigquery 2 Item Name Item Name"
view: nestedbigquery_2__item_name__item_name {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "Nestedbigquery 2 Item Name Item Name" in Explore.

# The name of this view in Looker is "Social Media Engagement 1"
view: social_media_engagement_1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `marketing_analytics.social_media_engagement_1` ;;
